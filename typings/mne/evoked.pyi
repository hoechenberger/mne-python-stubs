...
from .utils import ExtendedTimeMixin as ExtendedTimeMixin, SizeMixin as SizeMixin, check_fname as check_fname, copy_function_doc_to_method_doc as copy_function_doc_to_method_doc, fill_doc as fill_doc, logger as logger, repr_html as repr_html, sizeof_fmt as sizeof_fmt, verbose as verbose, warn as warn
from .viz import plot_evoked as plot_evoked, plot_evoked_field as plot_evoked_field, plot_evoked_image as plot_evoked_image, plot_evoked_topo as plot_evoked_topo, plot_evoked_topomap as plot_evoked_topomap
from .viz.evoked import plot_evoked_joint as plot_evoked_joint, plot_evoked_white as plot_evoked_white
from _typeshed import Incomplete

class Evoked(ProjMixin, ContainsMixin, UpdateChannelsMixin, ReferenceMixin, SetChannelsMixin, InterpolationMixin, FilterMixin, ExtendedTimeMixin, SizeMixin, SpectrumMixin):
    ...
    def __init__(self, fname, condition: Incomplete | None=..., proj: bool=..., kind: str=..., allow_maxshield: bool=..., *, verbose: Incomplete | None=...) -> None:
        ...
    ...
    def get_data(self, picks: Incomplete | None=..., units: Incomplete | None=..., tmin: Incomplete | None=..., tmax: Incomplete | None=...):
    ...
    def apply_function(self, fun, picks: Incomplete | None=..., dtype: Incomplete | None=..., n_jobs: Incomplete | None=..., verbose: Incomplete | None=..., **kwargs):
    ...
    * :class:`~mne.viz.ui_events.TimeChange` whenever a new time is selected.
    ...
    def plot_field(self, surf_maps, time: Incomplete | None=..., time_label: str=..., n_jobs: Incomplete | None=..., fig: Incomplete | None=..., vmax: Incomplete | None=..., n_contours: int=..., *, show_density: bool=..., alpha: Incomplete | None=..., interpolation: str=..., interaction: str=..., time_viewer: str=..., verbose: Incomplete | None=...):
    ...
    def plot_white(self, noise_cov, show: bool=..., rank: Incomplete | None=..., time_unit: str=..., sphere: Incomplete | None=..., axes: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def plot_joint(self, times: str=..., title: str=..., picks: Incomplete | None=..., exclude: str=..., show: bool=..., ts_args: Incomplete | None=..., topomap_args: Incomplete | None=...):
    ...
    def animate_topomap(self, ch_type: Incomplete | None=..., times: Incomplete | None=..., frame_rate: Incomplete | None=..., butterfly: bool=..., blit: bool=..., show: bool=..., time_unit: str=..., sphere: Incomplete | None=..., *, image_interp=..., extrapolate=..., vmin: Incomplete | None=..., vmax: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def detrend(self, order: int=..., picks: Incomplete | None=...):
        """Detrend data.
    ...
    def get_peak(self, ch_type: Incomplete | None=..., tmin: Incomplete | None=..., tmax: Incomplete | None=..., mode: str=..., time_as_index: bool=..., merge_grads: bool=..., return_amplitude: bool=...):
...
class EvokedArray(Evoked):
    ...
    * AU: misc
    ...
    def __init__(self, data, info, tmin: float=..., comment: str=..., nave: int=..., kind: str=..., baseline: Incomplete | None=..., *, verbose: Incomplete | None=...) -> None:
        ...
...
def read_evokeds(fname, condition: Incomplete | None=..., baseline: Incomplete | None=..., kind: str=..., proj: bool=..., allow_maxshield: bool=..., verbose: Incomplete | None=...):
...
def write_evokeds(fname, evoked, *, on_mismatch: str=..., overwrite: bool=..., verbose: Incomplete | None=...) -> None:
