...
from ._freesurfer import head_to_mni as head_to_mni, head_to_mri as head_to_mri, read_freesurfer_lut as read_freesurfer_lut
...
from .utils import ExtendedTimeMixin as ExtendedTimeMixin, TimeMixin as TimeMixin, check_fname as check_fname, copy_function_doc_to_method_doc as copy_function_doc_to_method_doc, fill_doc as fill_doc, logger as logger, verbose as verbose, warn as warn
from .viz import plot_dipole_amplitudes as plot_dipole_amplitudes, plot_dipole_locations as plot_dipole_locations
...
class Dipole(TimeMixin):
    ...
    def __init__(self, times, pos, amplitude, ori, gof, name: Incomplete | None=..., conf: Incomplete | None=..., khi2: Incomplete | None=..., nfree: Incomplete | None=..., *, verbose: Incomplete | None=...) -> None:
        ...
    ...
    def plot_locations(self, trans, subject, subjects_dir: Incomplete | None=..., mode: str=..., coord_frame: str=..., idx: str=..., show_all: bool=..., ax: Incomplete | None=..., block: bool=..., show: bool=..., scale: Incomplete | None=..., color: Incomplete | None=..., *, highlight_color: str=..., fig: Incomplete | None=..., title: Incomplete | None=..., head_source: str=..., surf: str=..., width: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def to_mni(self, subject, trans, subjects_dir: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def to_mri(self, subject, trans, subjects_dir: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def to_volume_labels(self, trans, subject: str=..., aseg: str=..., subjects_dir: Incomplete | None=..., verbose: Incomplete | None=...):
...
class DipoleFixed(ExtendedTimeMixin):
    ...
    def __init__(self, info, data, times, nave, aspect_kind, comment: str=..., *, verbose: Incomplete | None=...) -> None:
        ...
    ...
    def save(self, fname, verbose: Incomplete | None=...) -> None:
...
def read_dipole(fname, verbose: Incomplete | None=...):
...
def fit_dipole(evoked, cov, bem, trans: Incomplete | None=..., min_dist: float=..., n_jobs: Incomplete | None=..., pos: Incomplete | None=..., ori: Incomplete | None=..., rank: Incomplete | None=..., accuracy: str=..., tol: float=..., verbose: Incomplete | None=...):
    """Fit a dipole.
