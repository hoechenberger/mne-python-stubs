from .._fiff.compensator import make_compensator as make_compensator, set_current_comp as set_current_comp
from .._fiff.constants import FIFF as FIFF
from .._fiff.meas_info import ContainsMixin as ContainsMixin, SetChannelsMixin as SetChannelsMixin, write_meas_info as write_meas_info
from .._fiff.pick import channel_type as channel_type, pick_channels as pick_channels, pick_info as pick_info, pick_types as pick_types
from .._fiff.proj import ProjMixin as ProjMixin, activate_proj as activate_proj, setup_proj as setup_proj
from .._fiff.write import end_block as end_block, start_and_end_file as start_and_end_file, start_block as start_block, write_complex128 as write_complex128, write_complex64 as write_complex64, write_dau_pack16 as write_dau_pack16, write_double as write_double, write_float as write_float, write_id as write_id, write_int as write_int, write_string as write_string
...
from ..filter import FilterMixin as FilterMixin, notch_filter as notch_filter, resample as resample
from ..parallel import parallel_func as parallel_func
from ..time_frequency.spectrum import Spectrum as Spectrum, SpectrumMixin as SpectrumMixin
from ..utils import SizeMixin as SizeMixin, TimeMixin as TimeMixin, check_fname as check_fname, copy_doc as copy_doc, copy_function_doc_to_method_doc as copy_function_doc_to_method_doc, fill_doc as fill_doc, logger as logger, repr_html as repr_html, sizeof_fmt as sizeof_fmt, verbose as verbose, warn as warn
from ..viz import plot_raw as plot_raw
from _typeshed import Incomplete
from dataclasses import dataclass

class BaseRaw(ProjMixin, ContainsMixin, UpdateChannelsMixin, ReferenceMixin, SetChannelsMixin, InterpolationMixin, TimeMixin, SizeMixin, FilterMixin, SpectrumMixin):
    ...
    def __init__(self, info, preload: bool=..., first_samps=..., last_samps: Incomplete | None=..., filenames=..., raw_extras=..., orig_format: str=..., dtype=..., buffer_size_sec: float=..., orig_units: Incomplete | None=..., *, verbose: Incomplete | None=...) -> None:
        ...

    def apply_gradient_compensation(self, grade, verbose: Incomplete | None=...):
    ...
    def load_data(self, verbose: Incomplete | None=...):
        """Load raw data.
    ...
    def time_as_index(self, times, use_rounding: bool=..., origin: Incomplete | None=...):
    ...
    def set_annotations(self, annotations, emit_warning: bool=..., on_missing: str=..., *, verbose: Incomplete | None=...):
    ...
    def __exit__(self, exception_type: type[BaseException] | None, exception_val: BaseException | None, trace: types.TracebackType | None):
        """Exit with block."""
    ...
    def get_data(self, picks: Incomplete | None=..., start: int=..., stop: Incomplete | None=..., reject_by_annotation: Incomplete | None=..., return_times: bool=..., units: Incomplete | None=..., *, tmin: Incomplete | None=..., tmax: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def filter(self, l_freq, h_freq, picks: Incomplete | None=..., filter_length: str=..., l_trans_bandwidth: str=..., h_trans_bandwidth: str=..., n_jobs: Incomplete | None=..., method: str=..., iir_params: Incomplete | None=..., phase: str=..., fir_window: str=..., fir_design: str=..., skip_by_annotation=..., pad: str=..., verbose: Incomplete | None=...):
    ...
    def notch_filter(self, freqs, picks: Incomplete | None=..., filter_length: str=..., notch_widths: Incomplete | None=..., trans_bandwidth: float=..., n_jobs: Incomplete | None=..., method: str=..., iir_params: Incomplete | None=..., mt_bandwidth: Incomplete | None=..., p_value: float=..., phase: str=..., fir_window: str=..., fir_design: str=..., pad: str=..., skip_by_annotation=..., verbose: Incomplete | None=...):
    ...
    def resample(self, sfreq, npad: str=..., window: str=..., stim_picks: Incomplete | None=..., n_jobs: Incomplete | None=..., events: Incomplete | None=..., pad: str=..., verbose: Incomplete | None=...):
    ...
    def crop(self, tmin: float=..., tmax: Incomplete | None=..., include_tmax: bool=..., *, verbose: Incomplete | None=...):
        """Crop raw data file.
    ...
    def crop_by_annotations(self, annotations: Incomplete | None=..., *, verbose: Incomplete | None=...):
    ...
    def save(self, fname, picks: Incomplete | None=..., tmin: int=..., tmax: Incomplete | None=..., buffer_size_sec: Incomplete | None=..., drop_small_buffer: bool=..., proj: bool=..., fmt: str=..., overwrite: bool=..., split_size: str=..., split_naming: str=..., verbose: Incomplete | None=...) -> None:
    ...
    def export(self, fname, fmt: str=..., physical_range: str=..., add_ch_type: bool=..., *, overwrite: bool=..., verbose: Incomplete | None=...) -> None:
    ...
    def load_bad_channels(self, bad_file: Incomplete | None=..., force: bool=..., verbose: Incomplete | None=...) -> None:
    ...
    def append(self, raws, preload: Incomplete | None=...) -> None:
    ...
    def add_events(self, events, stim_channel: Incomplete | None=..., replace: bool=...) -> None:
    ...
    def compute_psd(self, method: str=..., fmin: int=..., fmax=..., tmin: Incomplete | None=..., tmax: Incomplete | None=..., picks: Incomplete | None=..., exclude=..., proj: bool=..., remove_dc: bool=..., reject_by_annotation: bool=..., *, n_jobs: int=..., verbose: Incomplete | None=..., **method_kw):
    ...
    def to_data_frame(self, picks: Incomplete | None=..., index: Incomplete | None=..., scalings: Incomplete | None=..., copy: bool=..., start: Incomplete | None=..., stop: Incomplete | None=..., long_format: bool=..., time_format: Incomplete | None=..., *, verbose: Incomplete | None=...):
...
def concatenate_raws(raws, preload: Incomplete | None=..., events_list: Incomplete | None=..., *, on_mismatch: str=..., verbose: Incomplete | None=...):
