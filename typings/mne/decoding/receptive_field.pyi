...
class ReceptiveField(BaseEstimator):
    ...
    def __init__(self, tmin, tmax, sfreq, feature_names: Incomplete | None=..., estimator: Incomplete | None=..., fit_intercept: Incomplete | None=..., scoring: str=..., patterns: bool=..., n_jobs: Incomplete | None=..., edge_correction: bool=..., verbose: Incomplete | None=...) -> None:
        ...
    delays_: Incomplete
