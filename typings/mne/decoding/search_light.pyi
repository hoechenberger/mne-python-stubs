...
from ..utils import ProgressBar as ProgressBar, array_split_idx as array_split_idx, fill_doc as fill_doc, verbose as verbose
...
class SlidingEstimator(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, base_estimator, scoring: Incomplete | None=..., n_jobs: Incomplete | None=..., *, position: int=..., allow_2d: bool=..., verbose: Incomplete | None=...) -> None:
        ...
