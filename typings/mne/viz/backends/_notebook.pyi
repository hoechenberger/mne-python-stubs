...
class _Text(_AbstractText, _Widget, Text, metaclass=_BaseWidget):
    def __init__(self, value=..., placeholder=..., callback=...) -> None: ...
...
class _FilePicker:
    def __init__(
        self, rows: int = ..., directory_only: bool = ..., ignore_dotfiles: bool = ...
    ) -> None: ...
    def show(self) -> None: ...
    def hide(self) -> None: ...
...
class _HBoxLayout(
    ...
    def __init__(self, height=..., scroll=...) -> None: ...

class _VBoxLayout(
    _AbstractVBoxLayout, _BoxLayout, _Widget, VBox, metaclass=_BaseWidget
):
    def __init__(self, width=..., scroll=...) -> None: ...
