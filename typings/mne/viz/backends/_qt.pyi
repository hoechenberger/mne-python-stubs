...
from qtpy.QtWidgets import QCheckBox, QComboBox, QDoubleSpinBox, QGridLayout, QGroupBox, QHBoxLayout, QLabel, QLineEdit, QMessageBox, QProgressBar, QPushButton, QScrollArea, QSlider, QVBoxLayout, QWidget
...
class _MNEMainWindow(MainWindow):
    ...
    def __init__(self, parent: Incomplete | None=..., title: Incomplete | None=..., size: Incomplete | None=...) -> None:
        ...
...
class QFloatSlider(QSlider):
    ...
    def __init__(self, ori, parent: Incomplete | None=...) -> None:
...
class _QtDialogWidget(_QtWidget):
    ...
    def show(self, thread: bool=...) -> None:
        ...
...
class _Renderer(_PyVistaRenderer, _QtDock, _QtToolBar, _QtMenuBar, _QtStatusBar, _QtWindow, _QtPlayback, _QtDialog, _QtKeyPress, _TimeInteraction):
