...
def plot_ica_properties(ica, inst, picks: Incomplete | None=..., axes: Incomplete | None=..., dB: bool=..., plot_std: bool=..., log_scale: bool=..., topomap_args: Incomplete | None=..., image_args: Incomplete | None=..., psd_args: Incomplete | None=..., figsize: Incomplete | None=..., show: bool=..., reject: str=..., reject_by_annotation: bool=..., *, verbose: Incomplete | None=...):
...
def plot_ica_scores(ica, scores, exclude: Incomplete | None=..., labels: Incomplete | None=..., axhline: Incomplete | None=..., title: str=..., figsize: Incomplete | None=..., n_cols: Incomplete | None=..., show: bool=...):
...
def plot_ica_overlay(ica, inst, exclude: Incomplete | None=..., picks: Incomplete | None=..., start: Incomplete | None=..., stop: Incomplete | None=..., title: Incomplete | None=..., show: bool=..., n_pca_components: Incomplete | None=..., *, on_baseline: str=..., verbose: Incomplete | None=...):
