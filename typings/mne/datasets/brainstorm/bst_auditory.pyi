def data_path(
    ...
    *,
    ...
    ----------
    path : None | str
        Location of where to look for the brainstorm (bst_auditory) dataset.
        If None, the environment variable or config parameter
        ``MNE_DATASETS_BRAINSTORM_DATA_PATH`` is used. If it doesn't exist, the
        "~/mne_data" directory is used. If the brainstorm (bst_auditory) dataset
    ...
    download : bool
        If False and the brainstorm (bst_auditory) dataset has not been downloaded yet,
