...
def gamma_map(evoked, forward, noise_cov, alpha, loose: str=..., depth: float=..., xyz_same_gamma: bool=..., maxit: int=..., tol: float=..., update_mode: int=..., gammas: Incomplete | None=..., pca: bool=..., return_residual: bool=..., return_as_dipoles: bool=..., rank: Incomplete | None=..., pick_ori: Incomplete | None=..., verbose: Incomplete | None=...):
