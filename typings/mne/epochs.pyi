...
from ._fiff.meas_info import ContainsMixin as ContainsMixin, SetChannelsMixin as SetChannelsMixin, read_meas_info as read_meas_info, write_meas_info as write_meas_info
from ._fiff.open import fiff_open as fiff_open
from ._fiff.pick import channel_indices_by_type as channel_indices_by_type, channel_type as channel_type, pick_channels as pick_channels, pick_info as pick_info
...
from ._fiff.write import INT32_MAX as INT32_MAX, end_block as end_block, start_and_end_file as start_and_end_file, start_block as start_block, write_complex_double_matrix as write_complex_double_matrix, write_complex_float_matrix as write_complex_float_matrix, write_double_matrix as write_double_matrix, write_float as write_float, write_float_matrix as write_float_matrix, write_id as write_id, write_int as write_int, write_string as write_string
from .annotations import EpochAnnotationsMixin as EpochAnnotationsMixin
from .baseline import rescale as rescale
from .channels.channels import InterpolationMixin as InterpolationMixin, ReferenceMixin as ReferenceMixin, UpdateChannelsMixin as UpdateChannelsMixin
from .event import make_fixed_length_events as make_fixed_length_events, match_event_names as match_event_names
...
from .time_frequency.spectrum import EpochsSpectrum as EpochsSpectrum, SpectrumMixin as SpectrumMixin
from .utils import ExtendedTimeMixin as ExtendedTimeMixin, GetEpochsMixin as GetEpochsMixin, SizeMixin as SizeMixin, check_fname as check_fname, check_random_state as check_random_state, copy_function_doc_to_method_doc as copy_function_doc_to_method_doc, logger as logger, object_size as object_size, repr_html as repr_html, sizeof_fmt as sizeof_fmt, verbose as verbose, warn as warn
from .utils.docs import fill_doc as fill_doc
from .viz import plot_drop_log as plot_drop_log, plot_epochs as plot_epochs, plot_epochs_image as plot_epochs_image, plot_topo_image_epochs as plot_topo_image_epochs
from _typeshed import Incomplete
from collections.abc import Generator

class BaseEpochs(ProjMixin, ContainsMixin, UpdateChannelsMixin, ReferenceMixin, SetChannelsMixin, InterpolationMixin, FilterMixin, ExtendedTimeMixin, SizeMixin, GetEpochsMixin, EpochAnnotationsMixin, SpectrumMixin):
    ...
    def __init__(self, info, data, events, event_id: Incomplete | None=..., tmin: float=..., tmax: float=..., baseline=..., raw: Incomplete | None=..., picks: Incomplete | None=..., reject: Incomplete | None=..., flat: Incomplete | None=..., decim: int=..., reject_tmin: Incomplete | None=..., reject_tmax: Incomplete | None=..., detrend: Incomplete | None=..., proj: bool=..., on_missing: str=..., preload_at_end: bool=..., selection: Incomplete | None=..., drop_log: Incomplete | None=..., filename: Incomplete | None=..., metadata: Incomplete | None=..., event_repeated: str=..., *, raw_sfreq: Incomplete | None=..., annotations: Incomplete | None=..., verbose: Incomplete | None=...) -> None:
        ...
    ...
    def iter_evoked(self, copy: bool=...) -> Generator[Incomplete, None, None]:
    ...
    def subtract_evoked(self, evoked: Incomplete | None=...):
    ...
    def average(self, picks: Incomplete | None=..., method: str=..., by_event_type: bool=...):
    ...
    def standard_error(self, picks: Incomplete | None=..., by_event_type: bool=...):
    ...
    def drop_bad(self, reject: str=..., flat: str=..., verbose: Incomplete | None=...):
    ...
    def drop_log_stats(self, ignore=...):
    ...
    def plot_drop_log(self, threshold: int=..., n_max_plot: int=..., subject: Incomplete | None=..., color=..., width: float=..., ignore=..., show: bool=...):
    ...
    def drop(self, indices, reason: str=..., verbose: Incomplete | None=...):
    ...
    def get_data(self, picks: Incomplete | None=..., item: Incomplete | None=..., units: Incomplete | None=..., tmin: Incomplete | None=..., tmax: Incomplete | None=..., *, copy: Incomplete | None=..., verbose: Incomplete | None=...):
    ...
    def apply_function(self, fun, picks: Incomplete | None=..., dtype: Incomplete | None=..., n_jobs: Incomplete | None=..., channel_wise: bool=..., verbose: Incomplete | None=..., **kwargs):
    ...
    def save(self, fname, split_size: str=..., fmt: str=..., overwrite: bool=..., split_naming: str=..., verbose: Incomplete | None=...) -> None:
    ...
    def export(self, fname, fmt: str=..., *, overwrite: bool=..., verbose: Incomplete | None=...) -> None:
    ...
    def equalize_event_counts(self, event_ids: Incomplete | None=..., method: str=...):
    ...
    def compute_psd(self, method: str=..., fmin: int=..., fmax=..., tmin: Incomplete | None=..., tmax: Incomplete | None=..., picks: Incomplete | None=..., proj: bool=..., remove_dc: bool=..., exclude=..., *, n_jobs: int=..., verbose: Incomplete | None=..., **method_kw):
    ...
    def to_data_frame(self, picks: Incomplete | None=..., index: Incomplete | None=..., scalings: Incomplete | None=..., copy: bool=..., long_format: bool=..., time_format: Incomplete | None=..., *, verbose: Incomplete | None=...):
...
def make_metadata(events, event_id, tmin, tmax, sfreq, row_events: Incomplete | None=..., keep_first: Incomplete | None=..., keep_last: Incomplete | None=...):
...
class Epochs(BaseEpochs):
    ...
    def __init__(self, raw, events, event_id: Incomplete | None=..., tmin: float=..., tmax: float=..., baseline=..., picks: Incomplete | None=..., preload: bool=..., reject: Incomplete | None=..., flat: Incomplete | None=..., proj: bool=..., decim: int=..., reject_tmin: Incomplete | None=..., reject_tmax: Incomplete | None=..., detrend: Incomplete | None=..., on_missing: str=..., reject_by_annotation: bool=..., metadata: Incomplete | None=..., event_repeated: str=..., verbose: Incomplete | None=...) -> None:
        ...
...
class EpochsArray(BaseEpochs):
    ...
    * AU: misc
    ...
    def __init__(self, data, info, events: Incomplete | None=..., tmin: int=..., event_id: Incomplete | None=..., reject: Incomplete | None=..., flat: Incomplete | None=..., reject_tmin: Incomplete | None=..., reject_tmax: Incomplete | None=..., baseline: Incomplete | None=..., proj: bool=..., on_missing: str=..., metadata: Incomplete | None=..., selection: Incomplete | None=..., *, drop_log: Incomplete | None=..., raw_sfreq: Incomplete | None=..., verbose: Incomplete | None=...) -> None:
        ...

def combine_event_ids(epochs, old_event_ids, new_event_id, copy: bool=...):
...
def equalize_epoch_counts(epochs_list, method: str=...) -> None:
...
def read_epochs(fname, proj: bool=..., preload: bool=..., verbose: Incomplete | None=...):
...
class EpochsFIF(BaseEpochs):
    ...
    def __init__(self, fname, proj: bool=..., preload: bool=..., verbose: Incomplete | None=...) -> None:
        ...

def bootstrap(epochs, random_state: Incomplete | None=...):
...
def concatenate_epochs(epochs_list, add_offset: bool=..., *, on_mismatch: str=..., verbose: Incomplete | None=...):
...
def average_movements(epochs, head_pos: Incomplete | None=..., orig_sfreq: Incomplete | None=..., picks: Incomplete | None=..., origin: str=..., weight_all: bool=..., int_order: int=..., ext_order: int=..., destination: Incomplete | None=..., ignore_ref: bool=..., return_mapping: bool=..., mag_scale: float=..., verbose: Incomplete | None=...):
...
def make_fixed_length_epochs(raw, duration: float=..., preload: bool=..., reject_by_annotation: bool=..., proj: bool=..., overlap: float=..., id: int=..., verbose: Incomplete | None=...):
