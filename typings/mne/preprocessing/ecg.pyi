...
from ..utils import int_like as int_like, logger as logger, sum_squared as sum_squared, verbose as verbose, warn as warn
from _typeshed import Incomplete

def qrs_detector(sfreq, ecg, thresh_value: float=..., levels: float=..., n_thresh: int=..., l_freq: int=..., h_freq: int=..., tstart: int=..., filter_length: str=..., verbose: Incomplete | None=...):
...
def find_ecg_events(raw, event_id: int=..., ch_name: Incomplete | None=..., tstart: float=..., l_freq: int=..., h_freq: int=..., qrs_threshold: str=..., filter_length: str=..., return_ecg: bool=..., reject_by_annotation: bool=..., verbose: Incomplete | None=...):
...
def create_ecg_epochs(raw, ch_name: Incomplete | None=..., event_id: int=..., picks: Incomplete | None=..., tmin: float=..., tmax: float=..., l_freq: int=..., h_freq: int=..., reject: Incomplete | None=..., flat: Incomplete | None=..., baseline: Incomplete | None=..., preload: bool=..., keep_ecg: bool=..., reject_by_annotation: bool=..., decim: int=..., verbose: Incomplete | None=...):
