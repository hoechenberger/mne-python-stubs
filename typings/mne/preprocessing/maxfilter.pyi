...
def apply_maxfilter(
    ...
    force: bool = False,
    st: bool = False,
    st_buflen: float = 16.0,
    st_corr: float = 0.96,
    mv_trans=None,
    mv_comp: bool = False,
    mv_headpos: bool = False,
    mv_hp=None,
    mv_hpistep=None,
    mv_hpisubt=None,
    mv_hpicons: bool = True,
    linefreq=None,
    cal=None,
    ctc=None,
    mx_args: str = "",
    ...
    """## ☠️ DEPRECATED apply_maxfilter will be removed in 1.7, use mne.preprocessing.maxwell_filter or the MEGIN command-line utility maxfilter and mne.bem.fit_sphere_to_headshape instead..
