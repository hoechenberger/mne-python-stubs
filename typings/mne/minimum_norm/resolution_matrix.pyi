...
from ..forward.forward import Forward as Forward, convert_forward_solution as convert_forward_solution
...
def make_inverse_resolution_matrix(forward, inverse_operator, method: str=..., lambda2=..., verbose: Incomplete | None=...):
...
def get_point_spread(resmat, src, idx, mode: Incomplete | None=..., *, n_comp: int=..., norm: bool=..., return_pca_vars: bool=..., vector: bool=..., verbose: Incomplete | None=...):
...
def get_cross_talk(resmat, src, idx, mode: Incomplete | None=..., *, n_comp: int=..., norm: bool=..., return_pca_vars: bool=..., vector: bool=..., verbose: Incomplete | None=...):
