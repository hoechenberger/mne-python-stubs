...
from ._fiff.write import end_block as end_block, start_and_end_file as start_and_end_file, start_block as start_block, write_float_sparse_rcs as write_float_sparse_rcs, write_int as write_int, write_string as write_string
from .surface import read_surface as read_surface
from .utils import get_subjects_dir as get_subjects_dir, logger as logger, verbose as verbose, warn as warn
from _typeshed import Incomplete

def read_morph_map(subject_from, subject_to, subjects_dir: Incomplete | None=..., xhemi: bool=..., verbose: Incomplete | None=...):
    """Read morph map.
