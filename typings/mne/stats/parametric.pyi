...
def f_threshold_mway_rm(n_subjects, factor_levels, effects: str=..., pvalue: float=...):
...
def f_mway_rm(data, factor_levels, effects: str=..., correction: bool=..., return_pvals: bool=...):
