...
class Projection(dict):
    ...
    def __init__(
        self, *, data, desc: str = ..., kind=..., active: bool = ..., explained_var=...
    ) -> None: ...
...
class ProjMixin:
    ...
    def add_proj(self, projs, remove_existing: bool = ..., verbose=...):
...
def activate_proj(projs, copy: bool = ..., verbose=...):
...
def deactivate_proj(projs, copy: bool = ..., verbose=...):
...
def make_eeg_average_ref_proj(
    info, activate: bool = ..., *, ch_type: str = ..., verbose=...
):
