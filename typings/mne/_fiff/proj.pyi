from ..utils import fill_doc as fill_doc, logger as logger, object_diff as object_diff, verbose as verbose, warn as warn
...
from .write import end_block as end_block, start_block as start_block, write_float as write_float, write_float_matrix as write_float_matrix, write_int as write_int, write_name_list_sanitized as write_name_list_sanitized, write_string as write_string
...
class Projection(dict):
    """Plot topographic maps of SSP projections.
        ...
        info : mne.Info
            The :class:`mne.Info` object with information about the sensors and methods of measurement. Used to determine the layout.
    ...
    def __init__(self, *, data, desc: str=..., kind=..., active: bool=..., explained_var: Incomplete | None=...) -> None:
        ...
    ...
    def plot_topomap(self, info, *, sensors: bool=..., show_names: bool=..., contours: int=..., outlines: str=..., sphere: Incomplete | None=..., image_interp=..., extrapolate=..., border=..., res: int=..., size: int=..., cmap: Incomplete | None=..., vlim=..., cnorm: Incomplete | None=..., colorbar: bool=..., cbar_fmt: str=..., units: Incomplete | None=..., axes: Incomplete | None=..., show: bool=...):
        """Plot topographic maps of SSP projections.
...
class ProjMixin:
    ...
    def add_proj(self, projs, remove_existing: bool=..., verbose: Incomplete | None=...):
    ...
    def apply_proj(self, verbose: Incomplete | None=...):
    ...
    def plot_projs_topomap(self, ch_type: Incomplete | None=..., *, sensors: bool=..., show_names: bool=..., contours: int=..., outlines: str=..., sphere: Incomplete | None=..., image_interp=..., extrapolate=..., border=..., res: int=..., size: int=..., cmap: Incomplete | None=..., vlim=..., cnorm: Incomplete | None=..., colorbar: bool=..., cbar_fmt: str=..., units: Incomplete | None=..., axes: Incomplete | None=..., show: bool=...):
        """Plot SSP vector.
...
def make_projector(projs, ch_names, bads=..., include_active: bool=...):
...
def make_projector_info(info, include_active: bool=...):
...
def activate_proj(projs, copy: bool=..., verbose: Incomplete | None=...):
...
def deactivate_proj(projs, copy: bool=..., verbose: Incomplete | None=...):
...
def make_eeg_average_ref_proj(info, activate: bool=..., *, ch_type: str=..., verbose: Incomplete | None=...):
...
def setup_proj(info, add_eeg_ref: bool=..., activate: bool=..., *, eeg_ref_ch_type: str=..., verbose: Incomplete | None=...):
    ...
    info : mne.Info
        The :class:`mne.Info` object with information about the sensors and methods of measurement. Warning: will be modified in-place.
    add_eeg_ref : bool
